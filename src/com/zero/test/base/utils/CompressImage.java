...
/**
 * 图片缩小
 * CompressImage compress = new CompressImage(context, filePath);// 获得图片压缩对象
 * Bitmap bitmap = compress.getBitmap();// 获得压缩之后的图片
 */
public class CompressImage {
    ...
    private Bitmap getimage() {
        ...
        bm = BitmapFactory.decodeFile(filePath, newOpts);// 此时返回bm为空
        ...
        return compressImage(bm);// 压缩好比例大小后再进行质量压缩
    }
